<p align="center">
  <img src="site/src/assets/logo.png" alt="monq" width="160" />
</p>

<h1 align="center">monq</h1>

<p align="center">Browse, query, edit. MongoDB without leaving the terminal.</p>

<p align="center"><a href="https://candril.github.io/monq/"><strong>Documentation</strong></a> · <a href="https://candril.github.io/monq/guide/installation/">Install</a> · <a href="https://candril.github.io/monq/reference/key-bindings/">Key bindings</a> · <a href="https://candril.github.io/monq/reference/query-syntax/">Query syntax</a></p>

> [!CAUTION]
> **Spec-driven, AI-generated.** Every feature in monq starts as a numbered spec in [`specs/`](specs/), and the code and this documentation were generated from those specs with an AI pair. Use it with care: monq *writes* to MongoDB — document edits, bulk updates and deletes, index changes, collection and database drops — each behind a confirmation. Use it on dev and staging data before anything you can't restore.
...
```sh
nix run github:candril/monq              # try it; `nix profile install github:candril/monq` keeps it
```
...
[release](https://github.com/candril/monq/releases), verified against its `SHA256SUMS` — prebuilt
...
monq is one of five, built the same way and installed the same way (`brew install candril/tap/<tool>`, `nix run github:candril/<tool>`, or the curl installer):
