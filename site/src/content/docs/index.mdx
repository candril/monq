...
head:
  - tag: title
    content: monq — browse, query and edit MongoDB from the terminal
hero:
  image:
...
<Aside type="caution">
**Spec-driven, AI-generated.** Every feature in monq starts as a numbered spec in [`specs/`](https://github.com/candril/monq/tree/main/specs), and the code and this documentation were generated from those specs with an AI pair. Use it with care: monq *writes* to MongoDB — document edits, bulk updates and deletes, index changes, collection and database drops — each behind a confirmation. Use it on dev and staging data before anything you can't restore.
</Aside>
...
![The README demo](../../assets/monq-demo.gif)
...
<CardGrid>
  ...
  <Card title="Document marks" icon="pen">
...
See the [installation guide](/monq/guide/installation/) for the Nix flake, the installer's
